...
class HyundaiPlatformConfig(PlatformConfig):
  ...
  def init(self):
    ...
    if self.flags & HyundaiFlags.MRR30_CAN_RADAR:
      self.dbc_dict = {Bus.pt: "hyundai_kia_generic", Bus.radar: 'hyundai_mrr30_can_radar_generated'}
...
class CAR(Platforms):
  ...
  HYUNDAI_KONA_EV_2ND_GEN = HyundaiCanFDPlatformConfig(
    ...
    flags=HyundaiFlags.EV | HyundaiFlags.CANFD_NO_RADAR_DISABLE | HyundaiFlags.MRR35_RADAR,
  )
