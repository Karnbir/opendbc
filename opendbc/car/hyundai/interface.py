...
from opendbc.car.hyundai.radar_interface import SCC_SELECTED_LEAD_ADDR, RADAR_START_ADDR
...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret: structs.CarParams, candidate, fingerprint, car_fw, alpha_long, is_release, docs) -> structs.CarParams:
    ...
    radar_addr = SCC_SELECTED_LEAD_ADDR if ret.flags & HyundaiFlags.SCC_SELECTED_LEAD else RADAR_START_ADDR
